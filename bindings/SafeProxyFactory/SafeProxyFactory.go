...
func CreateCreateProxyWithCallbackCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			transaction, transactionErr := session.CreateProxyWithCallback(
				singleton,
				initializer,
				saltNonce,
				callback,
...
func CreateCreateProxyWithNonceCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			transaction, transactionErr := session.CreateProxyWithNonce(
				singleton,
				initializer,
				saltNonce,
			)
...
func CreateCreateChainSpecificProxyWithNonceCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			transaction, transactionErr := session.CreateChainSpecificProxyWithNonce(
				singleton,
				initializer,
				saltNonce,
			)
